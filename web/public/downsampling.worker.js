...
// TO-DO : New version is here:
// https://github.com/Picovoice/web-voice-processor/blob/master/package/src/downsampling_worker.ts

onmessage = function (e) {
  switch (e.data.command) {
    case "init":
      console.log("DOWNSAMPLING-WORKER: init");
      init(e.data.inputSampleRate);
      break;
    case "process":
      console.log("DOWNSAMPLING-WORKER: process");
      process(e.data.inputFrame);
      break;
    case "reset":
      console.log("DOWNSAMPLING-WORKER: reset");
      reset();
      break;
    default:
  }
